...
public class Applet1 extends Applet {
	...
	ArrayList<Button> buttonNo= new ArrayList<Button>();
	...
	private void jbInit() throws Exception {
		...
		for(int a=1;a<=81;a++){
			buttonNo.get(a).setBounds(new Rectangle(20, 50, 45, 30));
			buttonNo.get(a).addKeyListener(new Applet1_button_keyAdapter[a](this));
		}
