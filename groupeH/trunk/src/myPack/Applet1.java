...
public class Applet1 extends Applet {
	...
	String setPoner(int k, int f, int c) {
		...
		int p = 0;
		if (juego.tablero.numCeros() == (juego.dimension * juego.dimension))
			p = 1;
		juego.putJugadas((juego.dimension * juego.dimension)
				- juego.tablero.numCeros() - 1, f, c, juego.tablero.getValor(f,
				c));
		return poner;
	}
	...
	void button1_keyPressed(KeyEvent e) {
		...
		if (poner.equals("0"))
			...
			if (juego.tablero.casillaValida(f, c, (new Integer(poner)
					.intValue())))
				color = Color.blue;
			else
				color = Color.red;
