...
public class PierreGroupe {
	...
	public void addCoords(int ligne, int colonne) throws NoCohesionException{
		...
		if(!place){
			throw new NoCohesionException("La pierre ne peut �tre ajout�e de fa�on coh�rente.");
		}
	}
	...
	public void setGroupe(ArrayList<Coords> groupe) throws NoCohesionException {
		if(this.checkCohesion(groupe)){
			...
			throw new NoCohesionException("Le groupe n'est pas coh�rent.");
		}
	...
	/**
	 * Compte les libert�s du groupe sur le goban donn�.
	 * @param goban
	 * @return
	 * @throws Exception 
	 */
