...
import fr.alma.server.core.Rule;
...
public class Go extends JFrame {
	...
	public Go() {
		...
		Rule rule = new Rule();
		Coordinator coordinator = new Coordinator(rule);
		
		
		IPlayer computer = new Computer("ordinateur", IPlayer.WHITE, strategy);
		strategy.setPlayer(computer);
		
		IPlayer player = new Player("vous", IPlayer.BLACK, goban, stateGame);
