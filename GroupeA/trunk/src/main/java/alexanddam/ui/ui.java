...
import static main.java.alexanddam.logic.FonctionEvaluation.goban;
				...
				public void mousePressed(MouseEvent mEvt){
			       ...
			       if(tourAdversair && p.x > Board.space && p.y > Board.space
			        && p.x < wB - Board.space && p.y < hB - Board.space) {			    	   			    	  
				        ...
				        if(goban[xc][yc] == 0 && main.java.alexanddam.logic.FonctionEvaluation.permissible(1, xc, yc)) {
				        	...
				        	if(deuxCoups >= 2) {
					        	...
					        	System.out.println("--> X : " + prochainCoup[0]);
					        	System.out.println("--> Y : " + prochainCoup[1]);
					        	if(compFirst)
